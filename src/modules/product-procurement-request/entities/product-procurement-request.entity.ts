...
/** DB-level values: IN_PROGRESS, CANCELED. Other statuses are computed from associated offers. */
...
export class ProductProcurementRequest {
  ...
  @Column({ default: ProductProcurementRequestStatus.IN_PROGRESS })
  status: ProductProcurementRequestStatus;
